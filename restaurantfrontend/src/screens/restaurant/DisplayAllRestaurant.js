  ...
  const handleSubmit=async()=>
   {  
     ...
     {   
      ...
      var body={'restaurantname':restaurantName,'ownername':ownerName,'phonenumber':phoneNumber,
     'emailid':emailid,'mobileno':mobileNumber,'address':address,'stateid':stateid,
     'cityid':cityid,'url':url,'fssai':fssai,'gstno':gstNo,'gsttype':gstType,
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={4}   >
              ...
              >
                ...
                onChange={handleFssai} hidden accept="image/*" multiple type="file" />
                Upload Fssai
              </Button>
              {
            ...
            <Grid item xs={4}>
              <Button
                ...
                endIcon={<UploadFile />}
              >
                <input onChange={handleLogo} hidden accept="image/*" multiple type="file" />
                Upload Logo
              </Button>
            </Grid>
        ...
        return (
          <MaterialTable
            ...
            columns={[
              ...
              { title: 'Documents',
              render:rowData=><><div>SA:{rowData.gstno}/{rowData.gsttype}</div><div>Fssai:{rowData.fssai}</div></> },
              { title: 'Website', 
