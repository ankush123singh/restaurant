...
export default function RestaurantInterface() {
  ...
  {  var submitRecord=true
    ...
    if(!fssai)
    {
     handleError(true,'fssai',"Pls Input Fssai No ")
      
     submitRecord=false
    }
    if(!gstNo)
    {
     handleError(true,'gstNo',"Pls Input Gst No")
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              <Select
               ...
               helperText={resError?.gstType?.message}
                label="GST Type"
                value={gstType}
          ...
          <Grid item xs={4}>
            ...
            >
              ...
              onChange={handleShopAct} hidden accept="image/*" multiple type="file" />
               Upload Shop Act
            </Button>
            {
          ...
          <Grid item xs={4}>
            ...
            >
              ...
              onChange={handleLogo} hidden accept="image/*" multiple type="file" />
              Upload Logo
            </Button>
            {
